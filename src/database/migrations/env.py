...
# Ideally this is stored in the db and you don't want them removed
IGNORE_TABLES = ['test']

def include_object(object, name, type_, reflected, compare_to):
    """
    Used to make alembic ignore specific existing db tables intead of dropping them
    Check for IGNORE_TABLES table and if ignore if it matches
    """
